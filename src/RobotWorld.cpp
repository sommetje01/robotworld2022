...
void RobotWorld::populate(int aNumberOfWalls) {
	 ...
	 static Point coordinates[] = { Point( 100, 200), Point( 300, 250),
	 Point( 600, 400), Point( 1000, 450),
	 Point( 150, 600), Point( 350, 700),
	 Point( 700, 800), Point( 900, 850),
	 };
	...
	RobotWorld::getRobotWorld().newGoal("Goal", Point(500, 950), false);
